...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='data/coco/annotations/train_grass.json',
        img_prefix='data/coco/train_grass/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='CocoDataset',
        ann_file='data/coco/annotations/val_grass.json',
        img_prefix='data/coco/val_grass/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    test=dict(
        type='CocoDataset',
        ann_file='data/coco/annotations/val_city.json',
        img_prefix='data/coco/val_city/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
work_dir = '/workspace/results/paste_lr2e-4_grass'
auto_resume = False
gpu_ids = range(0, 2)
